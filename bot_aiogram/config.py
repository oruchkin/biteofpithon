phone = '781548777'  # Номер киви
#qiwi_token = 'fwuigwefqwglhfdwq1b2e1889513ad'  # https://qiwi.com/api


#telegram_token = '1749213297:AAEwqdhiqo;w_dwwdvcajhvadwh1E'  # Бота создавать через @Botfather


#easyliker_token = 'jefwhefvewvfhwefedsdfPpckbrqCZHIKssqJTI'  # Токен получать тут https://easyliker.ru/profile/api



admins = [1457778443]  # список адинов через запятую
...
supports = 'TG: https://t.me/restzona1 Site: https://rest-zone.ru/'  # контакты тех.поддержки
