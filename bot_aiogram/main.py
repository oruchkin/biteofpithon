...
#print(json.dumps(global_service_data), ensure_ascii=False)
# json_string = json.dumps(global_service_data, sort_keys=True, indent=2, ensure_ascii=False)
# print(json_string)
...
global_service_data['response']['telegram']['reports'][0]['description'] = 'Офферы, среднее качество'
